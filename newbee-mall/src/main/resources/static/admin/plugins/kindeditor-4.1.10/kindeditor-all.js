    ...
    K.extend(KSWFUpload, {
        init: function (options) {
            ...
            self.div = K(options.container).html([
                ...
                '</div>',
                '<div style="height:23px;width:72px;float: left;background-image: url('+'/public/admin/kindeditor/plugins/multiimage/images/select-files-zh-CN.png'+')"></div>',
...
// Private: Called by Flash to see if JS can call in to Flash (testBeforeStart if External Interface is working)
