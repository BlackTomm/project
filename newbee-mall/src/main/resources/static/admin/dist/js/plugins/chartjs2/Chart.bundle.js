...
module.exports = {
	...
	modes: {
		...
		/**
		 * Point mode returns all elements that hit testBeforeStart based on the event position
		 * of the event
		...
		/**
		 * x mode returns the elements that hit-testBeforeStart at the current x coordinate
		...
		/**
		 * y mode returns the elements that hit-testBeforeStart at the current y coordinate
...
var helpers = {
	 ...
	 * @param {*} value - The value to testBeforeStart.
	 * @returns {Boolean}
	 * @since 2.7.0
	 */
